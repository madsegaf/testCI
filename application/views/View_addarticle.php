                ...
                <section class="content">
                            ...
                            <div class="panel-body">
                               ...
                               <!--  <div class="box-header">
                                ...
                                <!-- form start -->
                                <form method="post" action="<?php echo base_url()?>admmprs/addarticle_ok" enctype="multipart/form-data" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Title of Article</label>
                                            <input type="text" class="form-control"  name="judul" required="required" placeholder="Enter title ...">
                                        </div>
                                         <div class="form-group">
                                            <label>Content of Article</label>
                                            <textarea class="form-control" rows="3"  name="isi" required="required" placeholder="Enter content ..."></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Date Posting</label>
                                            <input type="date" class="form-control"  name="tanggal" required="required" placeholder="Enter content ...">
                                        </div>
                                        <div class="form-group">
