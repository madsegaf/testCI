        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            ...
                            <a href="<?php echo base_url();?>admmprs/galleryMpltd">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <a href="<?php echo base_url();?>admmprs/addarticle"><i class="fa fa-plus-square"></i>&nbsp;Add Article</a>
                         <div class="box-body table-responsive">
                            ...
                            <tbody>
                            <?php $no=0;
                                foreach ($data_article as $u){ ?>
                                <tr>
                                    <td align="center"><?php echo $no=$no+1; ?></td>
                                    <td><?php echo $u->title; ?></td>
                                    <td><?php echo substr($u->content, 0, 150)." ..."; ?></td>
                                    <td><?php echo $u->date; ?></td>
                                    <td><img src="<?php echo $u->photo; ?>" width="100%"></td>
                                    <td><?php echo $u->username; ?></td>
                                    <td align="center">
                                        <a class="btn btn-small fa fa-pencil" href="<?php echo base_url();?>admmprs/editarticle/<?php echo $u->id_article; ?>"></a>
                                        <a class="btn btn-small fa fa-trash-o" href="<?php echo base_url();?>admmprs/deletearticle/<?php echo $u->id_article; ?>" onClick="return confirm('Are you sure you want to delete this article?')"></a>&nbsp;&nbsp;

                                    <?php if($this->session->userdata('level')=="superadmin"){ ?>

                                            <?php if($u->is_posted=="0"){ ?>
                                            <a class="btn btn-small fa fa-arrow-circle-o-right" href="<?php echo base_url();?>admmprs/postarticle/<?php echo $u->id_article; ?>/<?php echo'drafted'; ?>" onClick="return confirm('Are you sure you want to post this article?')"></a>
                                             <?php }else if($u->is_posted=="1"){ ?> 
                                            <a class="btn btn-small fa fa-folder-open" href="<?php echo base_url();?>admmprs/postarticle/<?php echo $u->id_article; ?>/<?php echo'posted'; ?>" onClick="return confirm('Are you sure you want to draft this article?')"></a>
                                             <?php } ?>
