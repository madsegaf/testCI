...
<html>
 ...
 <script type="text/javascript" language="javascript" src="<?php echo site_url() ?>asset/js/jquery.dataTables.min.js"></script>
    <script type="text/javascript" language="javascript" src="<?php echo site_url() ?>asset/js/dataTables.bootstrap.js"></script>
